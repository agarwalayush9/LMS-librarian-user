...
struct EditBookDetailsView: View {
    ...
    var book: Book
    var updateBook: (Book) -> Void
    
    init(book: Book, updateBook: @escaping (Book) -> Void) {
        self.book = book
        self._bookTitle = State(initialValue: book.bookTitle)
...
struct BooksCatalogue: View {
    ...
    @State private var showingEditBookDetails = false
    ...
    var body: some View {
        ...
        .sheet(item: $bookToEdit) { book in
            EditBookDetailsView(book: book) { updatedBook in
